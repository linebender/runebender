...
fn tools_menu<T: Data>() -> Menu<T> {
    Menu::new(LocalizedString::new("menu-tools-menu").with_placeholder("Tools"))
        .entry(
            MenuItem::new(LocalizedString::new("menu-item-select-tool").with_placeholder("Select"))
                .on_activate(|ctx, _, _| ctx.submit_command(consts::cmd::SET_TOOL.with("Select")))
                .hotkey(SysMods::None, "v"),
        )
        .entry(
            MenuItem::new(LocalizedString::new("menu-item-pen-tool").with_placeholder("Pen"))
                .on_activate(|ctx, _, _| ctx.submit_command(consts::cmd::SET_TOOL.with("Pen")))
                .hotkey(SysMods::None, "p"),
        )
        .entry(
            MenuItem::new(LocalizedString::new("menu-item-hyperpen-tool").with_placeholder("Pen"))
                .on_activate(|ctx, _, _| ctx.submit_command(consts::cmd::SET_TOOL.with("HyperPen")))
        ...
        .entry(
            ...
            .on_activate(|ctx, _, _| ctx.submit_command(consts::cmd::SET_TOOL.with("Preview")))
        ...
        .entry(
            ...
            .on_activate(|ctx, _, _| ctx.submit_command(consts::cmd::SET_TOOL.with("Rectangle")))
        ...
        .entry(
            ...
            .on_activate(|ctx, _, _| ctx.submit_command(consts::cmd::SET_TOOL.with("Ellipse")))
            .hotkey(SysMods::Shift, "U"),
        )
        .entry(
            MenuItem::new(LocalizedString::new("menu-item-knife-tool").with_placeholder("Knife"))
                .on_activate(|ctx, _, _| ctx.submit_command(consts::cmd::SET_TOOL.with("Knife")))
        ...
        .entry(
            ...
            .on_activate(|ctx, _, _| ctx.submit_command(consts::cmd::SET_TOOL.with("Measure")))
